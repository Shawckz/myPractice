...
package com.shawckz.mypractice.base.database.mongo;

import com.google.common.primitives.Primitives;
import com.mongodb.client.FindIterable;
import com.mongodb.client.MongoCollection;
import com.mongodb.client.MongoCursor;
import com.shawckz.mypractice.base.configuration.AbstractSerializer;
import com.shawckz.mypractice.base.database.DatabaseManager;
import com.shawckz.mypractice.base.database.mongo.annotations.CollectionName;
import com.shawckz.mypractice.base.database.mongo.annotations.DatabaseSerializer;
...
public abstract class AutoMongo {
    ...
    public void update() {
        ...
        MongoCollection<Document> col = DatabaseManager.getDb().getCollection(tableName);
    ...
    public static List<AutoMongo> select(Document search, Class<? extends AutoMongo> type) {
        ...
        MongoCollection<Document> col = DatabaseManager.getDb().getCollection(collectionName.name());
    ...
    public static AutoMongo selectOne(Document search, Class<? extends AutoMongo> type) {
        ...
        if (cursor.hasNext()) {
            ...
            try {
                ...
                throw new RuntimeException("AutoMongo error selecting", e);
            }
